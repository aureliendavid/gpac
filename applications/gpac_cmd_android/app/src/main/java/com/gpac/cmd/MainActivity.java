...
public class MainActivity extends Activity {
	...
	private CmdTerminal myTerminal;


    private final static String LOG_LIB = "com.gpac.cmd.loader";
    ...
    public void reloadUIStatus() {
        ...
        ArrayList<String> cmdlineFile = readFromFile("gpac.cmdline.txt");
        ...
        ArrayList<String> stdoutFile = readFromFile("gpac.stderrout.txt");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cmdLineFile = this.getApplicationContext().getExternalFilesDir(null).getAbsolutePath() + "/gpac.cmdline.txt";
        outputFile = this.getApplicationContext().getExternalFilesDir(null).getAbsolutePath() + "/gpac.stderrout.txt";

        reloadUIStatus();

        myTerminal = new CmdTerminal();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                writeToFile(sCommandLine.toString(), "gpac.cmdline.txt");

            	myTerminal.run( sCommandLine.toString(),  outputFile);
